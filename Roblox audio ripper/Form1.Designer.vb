...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' LoadHTTP_BTN
        ' 
        LoadHTTP_BTN.Anchor = AnchorStyles.Bottom Or AnchorStyles.Left
        LoadHTTP_BTN.BackColor = Color.FromArgb(CByte(27), CByte(30), CByte(36))
        LoadHTTP_BTN.FlatAppearance.BorderColor = Color.FromArgb(CByte(64), CByte(64), CByte(64))
        LoadHTTP_BTN.FlatStyle = FlatStyle.Flat
        LoadHTTP_BTN.Font = New Font("Segoe UI", 12F)
        LoadHTTP_BTN.ForeColor = Color.White
        LoadHTTP_BTN.Location = New Point(6, 311)
        LoadHTTP_BTN.Name = "LoadHTTP_BTN"
        LoadHTTP_BTN.Size = New Size(75, 35)
        LoadHTTP_BTN.TabIndex = 2
        LoadHTTP_BTN.Text = "Load"
        LoadHTTP_BTN.UseVisualStyleBackColor = False
        ' 
        ' Download_BTN
        ' 
        ...
        Label1.TabIndex = 0
        Label1.Text = "Roblox Audio Ripper"
        ...
        TabPage2.Controls.Add(LoadHTTP_BTN)
        ...
        ClearHTTPTEMP_BTN.Text = "Clear TMP"
        ...
        Label6.TabIndex = 2
        Label6.Text = "Roblox Audio Ripper (made by zv800)"
        ...
        Text = "Roblox audio ripper (made by ZV800)"
    ...
    Friend WithEvents LoadHTTP_BTN As Button
